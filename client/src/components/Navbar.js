...
function Navbar() {
  ...
  const { loading:loadingGooglev, error:errorGooglev, data:dataGooglev } = useQuery(QUERY_GOOGLE_VOLUNTEER, {
    variables: {
      _id: userId,
    },
    skip: !userId
  ...
  const { loading:loadingCharity, error:errorCharity, data:dataCharity } = useQuery(QUERY_CHARITY, {
    variables: {
      _id: userId,
    },
    skip:!userId
  ...
  const { loading:loadingVolunteer, error:errorVolunteer, data:dataVolunteer } = useQuery(QUERY_VOLUNTEER, {
    variables: {
      _id: userId,
    },
    skip:!userId
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    {isLoggedIn ? charityNavigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    {isLoggedIn ? volunteerNavigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className={classNames(
